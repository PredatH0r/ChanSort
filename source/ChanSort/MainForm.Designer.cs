namespace ChanSort.Ui
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.colOutFav.FieldName = "_Favorites";
      ...
      this.colOutFav.UnboundDataType = typeof(string);
      // 
      ...
      this.colFavorites.FieldName = "_Favorites";
      this.colFavorites.Name = "colFavorites";
      this.colFavorites.UnboundDataType = typeof(string);
      // 
      ...
      this.repositoryItemCheckedComboBoxEdit2.MaskSettings.Set("MaskManagerType", typeof(DevExpress.Data.Mask.RegExpMaskManager));
      this.repositoryItemCheckedComboBoxEdit2.MaskSettings.Set("mask", null);
      this.repositoryItemCheckedComboBoxEdit2.MaskSettings.Set("allowBlankInput", true);
      ...
      this.repositoryItemCheckedComboBoxEdit2.ValidateOnEnterKey = true;
      // 
      // colLock
      // 
