namespace ChanSort.Ui
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.miMarkForSwapping = new DevExpress.XtraBars.BarButtonItem();
      this.miSwapWithMarked = new DevExpress.XtraBars.BarButtonItem();
      ...
      this.btnToggleLock.ImageOptions.Location = DevExpress.XtraEditors.ImageLocation.MiddleCenter;
      ...
      this.btnRenum.ImageOptions.Location = DevExpress.XtraEditors.ImageLocation.MiddleCenter;
      ...
      this.btnRemoveLeft.ImageOptions.Location = DevExpress.XtraEditors.ImageLocation.MiddleCenter;
      ...
      this.btnRemoveRight.ImageOptions.Location = DevExpress.XtraEditors.ImageLocation.MiddleCenter;
      ...
      this.bar1.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] {
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.miMarkForSwapping),
            new DevExpress.XtraBars.LinkPersistInfo(this.miSwapWithMarked),
      ...
      this.miDeleteBackup.ImageOptions.ImageIndex = ((int)(resources.GetObject("miDeleteBackup.ImageOptions.ImageIndex")));
      this.miDeleteBackup.ImageOptions.LargeImageIndex = ((int)(resources.GetObject("miDeleteBackup.ImageOptions.LargeImageIndex")));
      this.miDeleteBackup.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("miDeleteBackup.ImageOptions.SvgImage")));
      ...
      this.miSaveReferenceFile.ItemShortcut = new DevExpress.XtraBars.BarShortcut(((System.Windows.Forms.Keys.Shift | System.Windows.Forms.Keys.Alt) 
      ...
      // miConvert
      // 
      resources.ApplyResources(this.miConvert, "miConvert");
      this.miConvert.Id = 120;
      this.miConvert.ImageOptions.ImageIndex = ((int)(resources.GetObject("miConvert.ImageOptions.ImageIndex")));
      this.miConvert.ImageOptions.LargeImageIndex = ((int)(resources.GetObject("miConvert.ImageOptions.LargeImageIndex")));
      this.miConvert.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("miConvert.ImageOptions.SvgImage")));
      ...
      // miMarkForSwapping
      // 
      resources.ApplyResources(this.miMarkForSwapping, "miMarkForSwapping");
      this.miMarkForSwapping.ButtonStyle = DevExpress.XtraBars.BarButtonStyle.Check;
      this.miMarkForSwapping.Id = 118;
      this.miMarkForSwapping.ImageOptions.ImageIndex = ((int)(resources.GetObject("miMarkForSwapping.ImageOptions.ImageIndex")));
      this.miMarkForSwapping.ImageOptions.LargeImageIndex = ((int)(resources.GetObject("miMarkForSwapping.ImageOptions.LargeImageIndex")));
      this.miMarkForSwapping.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("miMarkForSwapping.ImageOptions.SvgImage")));
      this.miMarkForSwapping.ItemShortcut = new DevExpress.XtraBars.BarShortcut((System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.M));
      this.miMarkForSwapping.Name = "miMarkForSwapping";
      this.miMarkForSwapping.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.miMarkForSwapping_ItemClick);
      // 
      // miSwapWithMarked
      // 
      resources.ApplyResources(this.miSwapWithMarked, "miSwapWithMarked");
      this.miSwapWithMarked.Id = 119;
      this.miSwapWithMarked.ImageOptions.ImageIndex = ((int)(resources.GetObject("miSwapWithMarked.ImageOptions.ImageIndex")));
      this.miSwapWithMarked.ImageOptions.LargeImageIndex = ((int)(resources.GetObject("miSwapWithMarked.ImageOptions.LargeImageIndex")));
      this.miSwapWithMarked.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("miSwapWithMarked.ImageOptions.SvgImage")));
      this.miSwapWithMarked.ItemShortcut = new DevExpress.XtraBars.BarShortcut(((System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.Shift) 
                | System.Windows.Forms.Keys.M));
      this.miSwapWithMarked.Name = "miSwapWithMarked";
      this.miSwapWithMarked.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.miSwapWithMarked_ItemClick);
      // 
      // miRenameChannel
      // 
