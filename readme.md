...
It currently supports various models from Samsung, LG, Panasonic, Toshiba and the Linux VDR project.
...
Some features may not be available for every TV model and type of channel.
...
- USB-stick to transfer the channel list between your TV and PC
  (for some Panasonic models an SD-Card is needed instead)
